...
public class WebcamCaptureConfiguration implements RecordableConfiguration {
    ...
    WebcamCaptureConfiguration(String id,int id_camera, int fps) {
        this.id = id;
    ...
    public void setupRecording(File stageFolder, ProjectOrganization org, Participant p) {
         wr = new WebcamRecorder(stageFolder, org, p,id_camera,fps, this);
    }
    ...
    public File toFile(File parent) {
        try {
            File f = new File(parent, "webcam_"+id+"-"+id_camera+"_"+fps+".xml");
            f.createNewFile();
            return f;
    ...
    public Configuration fromFile(File file) {
        ...
        if (fileName.contains("_") && fileName.contains(".") && fileName.contains("-")){
            ...
            WebcamCaptureConfiguration c = new WebcamCaptureConfiguration(newId,Integer.parseInt(newId_camera),Integer.parseInt(newfps));
            return c;
        }
        return null;
    }
